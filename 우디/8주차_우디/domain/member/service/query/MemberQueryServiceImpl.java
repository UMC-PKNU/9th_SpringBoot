...
public class MemberQueryServiceImpl implements MemberQueryService {
    ...
    public Page<MemberResDto.GetMemberMissions> getMyMissions(Long memberId, MissionStatus status, Pageable pageable) {
        ...
        Page<MemberMission> missionsByMemberId = memberRepository.findMissionsByMemberId(memberId, pageable);

        // 2. 원본 Page에서 내용물(Object[] 리스트)을 꺼냅니다.
        List<MemberMission> originalContent = missionsByMemberId.getContent();
        ...
        for (MemberMission result : originalContent) {
