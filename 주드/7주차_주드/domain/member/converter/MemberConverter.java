...
public class MemberConverter {
    ...
    public static MemberResDTO.MyMissionDTO toMyMissionDTO(MemberMission memberMission) {
        ...
        return MemberResDTO.MyMissionDTO.builder()
                ...
                .storeName(memberMission.getMission().getStore().getName()) // Mission->Store->Name 가정
                .missionContent(memberMission.getMission().getContent())   // Mission->Spec (내용) 가정
                .reward(memberMission.getMission().getReward())             // Mission->Reward 가정
                .dDay(dDayStr)
                .build();
    }
