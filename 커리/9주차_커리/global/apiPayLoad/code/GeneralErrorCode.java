...
public enum GeneralErrorCode implements BaseErrorCode{
    ...
    // RequestParam 검증 실패
    REQUEST_PARAM_VALIDATION_FAILED(HttpStatus.BAD_REQUEST, "G-010", "RequestParam 검증에 실패했습니다."),

    // 커스텀 ValidPage 검증 실패
    PAGE_VALIDATION_FAILED(HttpStatus.BAD_REQUEST, "G-012", "page 값 검증에 실패했습니다."),
    ...
    USER_NOT_FOUND_VALIDATION_FAILED(HttpStatus.BAD_REQUEST, "G-013", "유효하지 않은 사용자입니다."),
    INVALID_PAGE(HttpStatus.BAD_REQUEST, "PAGE-004", "page 값이 유효하지 않습니다."),
